...
cockpit cockpit-ostree cockpit-packagekit u2f-server dotnet-sdk-9.0 yaru-theme yaru-gtk3-theme yaru-gtk4-theme yaru-icon-theme \
gnome-shell-theme-yaru yaru-theme yaru-sound-theme atuin
